  ...
  return (
    <div className="max-w-7xl mx-auto p-8">
      ...
      <section className="mb-16 p-8 bg-white rounded-lg shadow-lg">
        <h2 className="text-3xl text-blue-800 mb-6 font-bold">Who We Are</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
        <section className="p-8 bg-white rounded-lg shadow-lg transform transition-transform duration-300 hover:-translate-y-2">
          <h2 className="text-3xl text-blue-800 mb-6 font-bold">Our Vision</h2>
          <p className="text-lg leading-relaxed text-gray-700">
        ...
        <section className="p-8 bg-white rounded-lg shadow-lg transform transition-transform duration-300 hover:-translate-y-2">
          <h2 className="text-3xl text-blue-800 mb-6 font-bold">Our Mission</h2>
          <p className="text-lg leading-relaxed text-gray-700">
      ...
      <section className="p-8 bg-white rounded-lg shadow-lg">
        <h2 className="text-3xl text-blue-800 mb-8 text-center font-bold">Our Values</h2>
